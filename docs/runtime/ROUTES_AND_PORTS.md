...
|---|---|---:|---:|---|---|
| Frontend (Next.js) | `accrediops-frontend` | 3000 | via Caddy 18080 | `/`, `/projects/*`, `/admin/*` | `http://frontend:3000` |
| Backend (Django API) | `accrediops-backend` | 8000 | via Caddy 18080 | `/api/*` | `http://backend:8000/api/*` |
| Reverse Proxy (Caddy) | `accrediops-caddy` | 8080 | 18080 (host) | all browser traffic | rewrites/proxy to frontend/backend |
...
- Host Caddy domain mapping is locked to AccrediOps:
